...
def seed_database():
  ...
  Book.create("Flies Frisk", "Harper Lee", 1980, nooks.id)
  Book.create("Give and Take", "Harper Lee", 1980, nooks.id)
  ...
  Book.create("Dracula", "Spike Castle", 1930, castle.id)
  ...
  Book.create("Dracula", "Spike Castle", 1930, arch.id)
  Book.create("Lord of the Flies", "Harper Lee", 1980, arch.id)
  Book.create("Space", "Harper Lee", 1980, arch.id)
